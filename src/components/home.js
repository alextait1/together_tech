    ...
    <div>
        ...
        <div className="splash-row-2">
          <section className="about-container box">
            ...
            <p>We'll be keeping the <a className="cfp-link" href="https://docs.google.com/forms/d/e/1FAIpQLSddXXY4pohIWGpEiVvgPqO6wyamYdu3rm5WzqGVLirkjTNc7w/viewform" >call for proposals</a> link up and accepting rolling submissions.</p>
